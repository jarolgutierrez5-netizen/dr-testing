...
//   2. Matchup factor: today's opposing starter's HR-rate-allowed (and, when
//      available, their Statcast barrel/hard-hit rate) folded into one
//      multiplier (guide section 2). Computed by lib/liveProjections.js from
//      real MLB Stats API + Baseball Savant data and passed in as
//      batter.matchupFactor.
//   3. Park/weather factor: today's HR-friendliness multiplier (guide
//      section 3) -- a static park factor times a live weather nudge,
//      computed by lib/liveProjections.js and passed in as
//      batter.parkWeatherFactor.
//
...
const EXPECTED_PA_BY_ORDER = { 1: 4.5, 2: 4.4, 3: 4.35, 4: 4.3, 5: 4.2, 6: 4.1, 7: 3.9, 8: 3.8, 9: 3.6 };
